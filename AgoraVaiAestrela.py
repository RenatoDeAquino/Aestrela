...
while node_atual.upper() != "M":
    if node_atual.upper() == "A":
        for x in range(0,len(a)):
            if a[x] == "B":
                topzera_1 = a[x + 1] + distancia[3]
            if a[x] == "C":
                topzera_2 = a[x + 1] + distancia[5]
...
#____________________________________________________________
    if node_atual.upper() == "B":
        for x in range(0,len(b)):
            if b[x] == "A":
                topzera_1 = b[x + 1] + distancia[1]
                print(topzera_1)
            if b[x] == "D":
                topzera_2 = b[x + 1] + distancia[7]
                print(topzera_2)
        if topzera_1 > topzera_2:
            node_path.append("D")
            node_atual = "d"
...
#______________________________________________________________________________
    if node_atual.upper() == "C":
        for x in range(0,len(c)):
            if c[x] == "A":
                topzera_1 = c[x + 1] + distancia[1]
            if c[x] == "D":
                topzera_2 = b[x + 1] + distancia[7]
            if c[x] == "F":
                topzera_3 = c[x + 1] + distancia[11]
            if c[x] == "L":
                topzera_4 = c[x + 1] + distancia[23]
...
#______________________________________________________________________________
    if node_atual.upper() == "D":
        for x in range(0,len(d)):
            if d[x] == "B":
                topzera_1 = d[x + 1] + distancia[3]
            if d[x] == "C":
                topzera_2 = d[x + 1] + distancia[5]
            if d[x] == "E":
                topzera_3 = d[x + 1] + distancia[9]
...
#______________________________________________________________________________
    if node_atual.upper() == "E":
        for x in range(0,len(e)):
            if e[x] == "D":
                topzera_1 = e[x + 1] + distancia[7]
            if e[x] == "G":
                topzera_2 = e[x + 1] + distancia[13]
        if topzera_1 > topzera_2:
            node_path.append("G")
            node_atual = "g"
        else:
...
#______________________________________________________________________________
    if node_atual.upper() == "F":
        for x in range(0,len(f)):
            if f[x] == "C":
                topzera_1 = f[x + 1] + distancia[5]
            if f[x] == "K":
                topzera_2 = f[x + 1] + distancia[21]
            if f[x] == "J":
                topzera_3 = f[x + 1] + distancia[19]
        if topzera_1 < topzera_2 and topzera_1 < topzera_3:
            node_path.append("C")
            node_atual = "c"
        if topzera_2 < topzera_1 and topzera_2 < topzera_3:
...
#______________________________________________________________________________
    if node_atual.upper() == "G":
        for x in range(0,len(g)):
            if g[x] == "E":
                topzera_1 = g[x + 1] + distancia[9]
            if b[x] == "H":
                topzera_2 = g[x + 1] + distancia[15]
        if topzera_1 > topzera_2:
            node_path.append("H")
            node_atual = "h"
        else:
...
#______________________________________________________________________________
    if node_atual.upper() == "H":
        for x in range(0,len(h)):
            if h[x] == "G":
                topzera_1 = h[x + 1] + distancia[13]
            if h[x] == "I":
                topzera_2 = h[x + 1] + distancia[17]
        if topzera_1 > topzera_2:
            node_path.append("I")
            node_atual = "i"
        else:
...
#______________________________________________________________________________
    if node_atual.upper() == "I":
        for x in range(0,len(i)):
            if i[x] == "H":
                topzera_1 = i[x + 1] + distancia[15]
            if i[x] == "J":
                topzera_2 = i[x + 1] + distancia[19]
        if topzera_1 > topzera_2:
            node_path.append("J")
            node_atual = "j"
        else:
...
#______________________________________________________________________________
    if node_atual.upper() == "J":
        for x in range(0,len(j)):
            if j[x] == "I":
                topzera_1 = j[x + 1] + distancia[17]
            if j[x] == "F":
                topzera_2 = j[x + 1] + distancia[11]
            if j[x] == "K":
                topzera_3 = j[x + 1] + distancia[21]
        if topzera_1 < topzera_2 and topzera_1 < topzera_3:
            node_path.append("I")
            node_atual = "i"
        if topzera_2 < topzera_1 and topzera_2 < topzera_3:
...
#______________________________________________________________________________
    if node_atual.upper() == "K":
        for x in range(0,len(k)):
            if k[x] == "J":
                topzera_1 = k[x + 1] + distancia[19]
            if k[x] == "F":
                topzera_2 = k[x + 1] + distancia[11]
            if k[x] == "M":
                topzera_3 = k[x + 1] + 0
        if topzera_1 < topzera_2 and topzera_1 < topzera_3:
            node_path.append("J")
